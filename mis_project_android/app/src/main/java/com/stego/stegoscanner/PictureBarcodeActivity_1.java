...
public class PictureBarcodeActivity_1 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnOpenCamera:
                ActivityCompat.requestPermissions(PictureBarcodeActivity_1.this, new
    ...
    private void takeBarcodePicture() {
        ...
        imageUri = FileProvider.getUriForFile(PictureBarcodeActivity_1.this,
